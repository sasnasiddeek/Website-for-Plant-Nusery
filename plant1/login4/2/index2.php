...
<body>
<img src="img/bg/bg3.jpg" alt="Nature" class="responsive">
          ...
          <div class="col-lg-6 order-lg-1">
            <div class="p-5">
              ...
              <p>  Category    Hotels<br>
                    ...
                    Website: <a href="https://www.amagiresort.com.com">www.amagiresort.com</a><br>
...
<nav aria-label="Page navigation">
  <ul class="pagination justify-content-center">
    ...
    <li class="page-item">
      <a class="page-link" href="index4.php">Next</a>
    </li>
  </ul>
</nav>
