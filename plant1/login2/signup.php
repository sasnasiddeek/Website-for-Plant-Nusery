...
function adminLogin($username,$user_pwd,$db)
{
  $sql="SELECT username,user_pwd FROM register WHERE username='$username' AND user_pwd='$user_pwd'";
  $ma=$db->query($sql);
  if($ma)
  {
    if($ma->num_rows==1)
                                ...
                                if(isset($_POST["submit"]))
{
  ...
  adminLogin($username,$user_pwd,$db);
 
  echo "<font color=red><center> username or user_pwdword is Incorrect</center></font>";
}  
                                ?>
